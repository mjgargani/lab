...
describe('GitHub API model', () => {
  it('fetchProfile calls correct url', async () => {
    ...
    expect(global.fetch).toHaveBeenCalledWith('https://api.github.com/users/mjgargani');
  ...
  it('fetchRepos calls correct url', async () => {
    ...
    expect(global.fetch).toHaveBeenCalledWith('https://api.github.com/users/mjgargani/repos?per_page=100');
